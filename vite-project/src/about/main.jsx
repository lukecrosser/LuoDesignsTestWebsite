...
<   div className="mx-auto w-fit flex justify-between items-center mt-20">
          <div className="hero-content flex-col lg:flex-row gap-40 inset-x-0 top-0 -mt-40">
              <div className="max-w-sm rounded-lg">
              <Chat />
              </div>
              <div>
                  <h1 className="text-5xl text-black font-bold ">Say goodbye to Web Design!</h1>
                  <p className="py-6">If you sign with us you'll never have to deal
              with hiring new designers every year and trying to keep your website up to date.
              We will take care of everything for you!</p>
              </div>
          </div>
          </div>
